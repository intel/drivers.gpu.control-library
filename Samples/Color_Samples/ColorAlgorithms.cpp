...
/***************************************************************
 * @brief
 * CreateMatrixForMappingPanelToSRGBColorSpace
 * This funtion is called with PanelColorSpace which maps it with the SRGB color space
 * @param ColorSpace, GeneratedOutputMatrix[3][3]
 * @return void
 ***************************************************************/
void CreateMatrixForMappingPanelToSRGBColorSpace(ColorSpace PanelColorSpace, double GeneratedOutputMatrix[3][3])
{
    // standard SRGB color space harcoded https://en.wikipedia.org/wiki/SRGB
